  ...
  async function runSelectQuery(id) {
    ...
    if (results.rowCount === 0) {
      throw new NotFoundError({
        message: "The provided id wasn't found.",
        action: "Verify if the id is properly typed.",
      });
    }
...
async function findOneByEmail(email) {
  ...
  async function runSelectQuery(email) {
    ...
    if (results.rowCount === 0) {
      throw new NotFoundError({
        message: "The provided email wasn't found.",
        action: "Verify if the email is properly typed.",
      });
    }
